...
if (isset($_GET['search'])) {
    ...
    // Modify SQL query to search across multiple fields, including expiration_date
...
<header>
    <nav>
        ...
        <ul>
            ...
            <li><a href="view_products.php" class="home"><i class="fas fa-eye"></i>View All Products</a></li>
            <li><a href="../home/notification.php" class="notif" target="_self"><i class="fas fa-bell"></i> </a></li>
